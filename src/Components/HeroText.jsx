...
const HeroText = () => {
    ...
    <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
        ...
        <div className="flex-col hidden md:flex c-space">
            <motion.h1 className="text-4xl font-medium text-neutral-300"
            variants={variants}
            initial = "hidden"
            animate = "visible"
            transition = {{delay:1}}
            ...
            <div className="flex flex-col items-start">
                ...
                >
                        <FlipWords
                        words={words}
                        className="text-neutral-400 font-black text-8xl"/>
                    </motion.div>
                    <motion.p className="text-4xl font-medium text-neutral-400"
                        variants={variants}
                        initial = "hidden"
                        animate = "visible"
